...
CREATE TABLE `defaults` (
  ...
  CONSTRAINT `fk_defaults_exhibition` FOREIGN KEY (`ShowID`) REFERENCES `exhibition` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `defaults` VALUES (1,'bhs',11);
