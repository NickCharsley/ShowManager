...
class doExhibitionclass extends DB_DataObject 
{
    ###START_AUTOCODE
    ...
    public $ClassNumber;                     // int(4)  unique_key not_null
    public $ClassID;                         // int(4)  unique_key not_null

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('doExhibitionclass',$k,$v); }
